...
public class Utils {
     ...
     */
    public static <T> T newInstance(Object klass, Class<T> base) throws ClassNotFoundException {
    	if (klass instanceof String)
    		return Utils.newInstance(Class.forName((String) klass, true, Utils.getContextOrKafkaClassLoader()).asSubclass(base));
    	else
    		return Utils.newInstance(((Class<T>) klass).asSubclass(base));
    }
