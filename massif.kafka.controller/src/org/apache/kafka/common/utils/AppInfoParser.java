...
public class AppInfoParser {
    ...
    static {
        try {
            ...
            props.load(Bundle.class.getClassLoader().getResourceAsStream("/resources/kafka-version.properties"));
    ...
    public static class AppInfo implements AppInfoMBean {
        ...
        public AppInfo() {
            log.debug("Kafka version : " + AppInfoParser.getVersion());
            log.debug("Kafka commitId : " + AppInfoParser.getCommitId());
        }
